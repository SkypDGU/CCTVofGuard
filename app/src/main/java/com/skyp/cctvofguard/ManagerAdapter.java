...
public class ManagerAdapter extends RecyclerView.Adapter<ManagerAdapter.ManagerViewHolder> {
    ...
    public class ManagerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ManagerViewHolder(View v){
            super(v);
    ...
    public ManagerAdapter(ArrayList<cctvData> tempData) {
        tempList = tempData;
    }
    ...
    public ManagerAdapter.ManagerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ManagerAdapter.ManagerViewHolder vh = new ManagerAdapter.ManagerViewHolder(view);
        return vh;
    }
